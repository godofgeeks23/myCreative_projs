...
// PhysicalObject.prototype.scale = function(px,py) {
//     Matter.Body.scale(this.body, px, py);
//   };

// PhysicalObject.prototype.scaleADV = function(valx,valy,px,py) {
//     Matter.Body.scale(this.body, valx, valy, {x: px, y: py});
//   };
